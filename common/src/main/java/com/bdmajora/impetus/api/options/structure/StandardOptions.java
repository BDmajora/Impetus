...
public final class StandardOptions {
    private static final String IMPETUS_MOD_ID = "impetus";
    ...
    public static class Group {
        ...
        public static final OptionIdentifier<Void> CHUNK_UPDATES = OptionIdentifier.create(IMPETUS_MOD_ID, "chunk_updates");
        public static final OptionIdentifier<Void> RENDERING_CULLING = OptionIdentifier.create(IMPETUS_MOD_ID, "rendering_culling");
    ...
    public static class Pages {
        public static final OptionIdentifier<Void> GENERAL = OptionIdentifier.create(IMPETUS_MOD_ID, "general");
        public static final OptionIdentifier<Void> QUALITY = OptionIdentifier.create(IMPETUS_MOD_ID, "quality");
        public static final OptionIdentifier<Void> PERFORMANCE = OptionIdentifier.create(IMPETUS_MOD_ID, "performance");
        public static final OptionIdentifier<Void> ADVANCED = OptionIdentifier.create(IMPETUS_MOD_ID, "advanced");
        public static final OptionIdentifier<Void> SHADERS = OptionIdentifier.create(IMPETUS_MOD_ID, "shaders");
    }
    ...
    public static class Option {
        ...
        public static final OptionIdentifier<Void> COMPACT_VERTEX_FORMAT = OptionIdentifier.create(IMPETUS_MOD_ID, "compact_vertex_format");
        public static final OptionIdentifier<Void> FOG_OCCLUSION = OptionIdentifier.create(IMPETUS_MOD_ID, "fog_occlusion");
        public static final OptionIdentifier<Void> ENTITY_CULLING = OptionIdentifier.create(IMPETUS_MOD_ID, "entity_culling");
        ...
        public static final OptionIdentifier<Void> RENDER_PASS_OPTIMIZATION = OptionIdentifier.create(IMPETUS_MOD_ID, "render_pass_optimization");
        public static final OptionIdentifier<Void> RENDER_PASS_CONSOLIDATION = OptionIdentifier.create(IMPETUS_MOD_ID, "render_pass_consolidation");
